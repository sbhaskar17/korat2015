...
public class TestCradle extends AbstractTestCaseGenerator implements ITester {
    ...
    IIntSet tostate, fromstate;
    
    private void start(Class clazz, String[] finArgs)
            throws KoratTestException {
    	
    	if (new FSMModel().isFSMModel(clazz)) {
    		TestCradleFSM testCradle = TestCradleFSM.getInstance();
    		//new TestCradleFSM().startTestGenerationFSM(clazz, finArgs);
    		testCradle.startTestGenerationFSM(clazz, finArgs);
